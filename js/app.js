...
let menuWatch = document.querySelector('.menu__watch');
let headerIcon = document.querySelector('.header__icon');

menuWatch.addEventListener("click", someClick);

function someClick() {
	headerIcon.classList.toggle('_active');
	menuWatch.classList.toggle('_active');
}
//==========================================================
...
//===============================================================
const tabsNewsBody = document.querySelector('.tabs-news__body');

tabsNewsBody.addEventListener("click", function (e) {
	const targetElem = e.target;
	if (targetElem.classList.contains('column-tabs__more')) {
...
//====================================================================
const investorContainer = document.querySelector('.investor__container');

investorContainer.addEventListener("click", function (e) {
	const targetElem = e.target;

	if (targetElem.classList.contains('investor__button')) {
...
async function readMoreQuestions(targetElem) {
	...
	if (response.ok) {
		...
		const investorCounter = document.querySelector('.investor__block');
